    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <hr>
                <div class="thumbnail">
                    <img src="<?php echo e(asset('images/face2_80X80.png')); ?>" alt="Mwalima Peltenburg" class="img-circle">
                </div><!-- /thumbnail -->
                <h1><?php echo e($name); ?></h1>
                <h3><?php echo e($city); ?>,<?php echo e($city); ?></h3>
                <br>
                <div class="info-user">
            ...
            <div class="col-sm-3 col-lg-3">
                ...
                <div class="half-unit">
                    ...
                    <hr>
                    <div class="cont">
                        <p><img src="<?php echo e(asset('images/up.png')); ?>" alt=""> <bold>Up</bold> | 356ms.</p>
                    </div>
                </div>
            </div>
        </div><!-- /row -->
        ...
        <div class="row">
            <div class="col-sm-3 col-lg-3">
                <!-- MAIL BLOCK -->
                <div class="dash-unit">
                    <dtitle>You received a message from <?php echo e($count); ?></dtitle>
                    <hr>
                    <div class="framemail">
                        <div class="window">
                            <ul class="mail">
                                ...
                                <li>
                                    <i class="unread"></i>
                                    <img class="avatar" src="<?php echo e(asset('images/photo01.jpeg')); ?>" alt="avatar">
                                ...
                                <li>
                                    <i class="read"></i>
                                    <img class="avatar" src="<?php echo e(asset('images/photo02.jpg')); ?>" alt="avatar">
                                ...
                                <li>
                                    <i class="read"></i>
                                    <img class="avatar" src="<?php echo e(asset('images/photo03.jpg')); ?>" alt="avatar">
                                ...
                                <li>
                                    <i class="read"></i>
                                    <img class="avatar" src="<?php echo e(asset('images/photo04.jpg')); ?>" alt="avatar">
            ...
            <div class="col-sm-3 col-lg-3">
                <div class="dash-unit">
                    ...
                    <div class="cont">
                        ...
                        <br>
                        <p><img src="<?php echo e(asset('images/up-small.png')); ?>" alt=""> 12% Compared Last Month</p>
            ...
            <div class="col-sm-3 col-lg-3">
                <div class="dash-unit">
                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            <li><img src="<?php echo e(asset('images/slide01.png')); ?>" alt="slider"></li>
                            <li><img src="<?php echo e(asset('images/slide02.png')); ?>" alt="slider"></li>
                        </ul>
                    </div>
                    <div class="cont">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-lg-3">
                ...
                <div class="half-unit">
                    ...
                    <div class="cont">
                        <p><bold>388</bold></p>
                        <p><img src="<?php echo e(asset('images/up-small.png')); ?>" alt=""> 412 Max. | <img src="<?php echo e(asset('images/down-small.png')); ?>" alt=""> 89 Min.</p>
                    </div>
                </div>
                ...
                <div class="half-unit">
                    ...
                    <div class="cont">
                        ...
                        <p><img src="<?php echo e(asset('images/up-small.png')); ?>" alt=""> 23.88%</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-lg-3">
                <div class="dash-unit">
                    ...
                    <div class="accordion" id="accordion2">
                        ...
                        <div class="accordion-group">
                            <?php echo $__env->make('components.accordion_group', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div><!--/accordion -->
                </div>
            </div>
            ...
            <div class="col-sm-3 col-lg-3">
                ...
                <!-- LAST USER BLOCK -->
                <div class="half-unit">
                    <?php echo $__env->make('components.last_user', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>

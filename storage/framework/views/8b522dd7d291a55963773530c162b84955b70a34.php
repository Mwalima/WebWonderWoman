...
<html><head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('theme/bootstrap/css/bootstrap.min.css')); ?>" />

    <link href="<?php echo e(asset('theme/css/main.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('theme/css/font-style.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('theme/css/flexslider.css')); ?>" rel="stylesheet">

    <script type="text/javascript" src="<?php echo e(asset('/theme/js/jquery.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('theme/bootstrap/js/bootstrap.min.js')); ?>"></script>

    <script type="text/javascript" src="<?php echo e(asset('theme/js/lineandbars.js')); ?>"></script>

    <script type="text/javascript" src="<?php echo e(asset('theme/js/dash-charts.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('theme/js/gauge.js')); ?>"></script>

    <!-- NOTY JAVASCRIPT -->
    <script type="text/javascript" src="<?php echo e(asset('theme/js/jquery.noty.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('theme/js/noty/layouts/top.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('theme/js/noty/layouts/topLeft.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('theme/js/noty/layouts/topRight.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('theme/js/noty/layouts/topCenter.js')); ?>"></script>
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <hr>
                <div class="thumbnail">
                    <img src="<?php echo e(HTML::image('public/favicon.ico')); ?>" alt="Marcel Newman" class="img-circle">
                </div><!-- /thumbnail -->
                <h1>Marcel Newman</h1>
                <h3>Madrid, Spain</h3>
                <br>
        ...
        <div class="col-sm-3 col-lg-3">
            ...
            <div class="half-unit">
                ...
                <hr>
                <div class="cont">
                    <p><img src="/theme/images/up.png" alt=""> <bold>Up</bold> | 356ms.</p>
                </div>
            </div>
                ...
                <div class="framemail">
                    <div class="window">
                        <ul class="mail">
                            ...
                            <li>
                                <i class="read"></i>
                                <img class="avatar" src="../../../theme/images/photo03.jpg" alt="avatar">
                            ...
                            <li>
                                <i class="read"></i>
                                <img class="avatar" src="../../theme/images/photo04.jpg" alt="avatar">
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <div class="cont">
                    ...
                    <br>
                    <p><img src="/theme/images/up-small.png" alt=""> 12% Compared Last Month</p>
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <div class="flexslider">
                    <ul class="slides">
                        <li><img src="/theme/images/slide01.png" alt="slider"></li>
                        <li><img src="/theme/images/slide02.png" alt="slider"></li>
                    </ul>
                </div>
                <div class="cont">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-lg-3">
            ...
            <div class="half-unit">
                ...
                <div class="cont">
                    <p><bold>388</bold></p>
                    <p><img src="/theme/images/up-small.png" alt=""> 412 Max. | <img src="images/down-small.png" alt=""> 89 Min.</p>
                </div>
            </div>
            ...
            <div class="half-unit">
                ...
                <div class="cont">
                    ...
                    <p><img src="/theme/images/up-small.png" alt=""> 23.88%</p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <p><img src="/theme/images/logo.png" alt=""></p>

                ...
                <div class="framemail">
                    <div class="window">
                        <ul class="mail">
                            ...
                            <li>
                                <i class="read"></i>
                                <img class="avatar" src="{{ asset('images/photo02.jpg')}}" alt="avatar">
                            ...
                            <li>
                                <i class="read"></i>
                                <img class="avatar" src="{{ asset('images/photo03.jpg')}}" alt="avatar">
                            ...
                            <li>
                                <i class="read"></i>
                                <img class="avatar" src="{{ asset('images/photo04.jpg')}}" alt="avatar">
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <div class="cont">
                    ...
                    <br>
                    <p><img src="{{ asset('images/up-small.png')}}" alt=""> 12% Compared Last Month</p>
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <div class="flexslider">
                    <ul class="slides">
                        <li><img src="{{ asset('images/slide01.png')}}" alt="slider"></li>
                        <li><img src="{{ asset('images/slide02.png')}}" alt="slider"></li>
                    </ul>
                </div>
                <div class="cont">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-lg-3">
            ...
            <div class="half-unit">
                ...
                <div class="cont">
                    <p><bold>388</bold></p>
                    <p><img src="{{ asset('images/up-small.png')}}" alt=""> 412 Max. | <img src="{{ asset('images/down-small.png')}}" alt=""> 89 Min.</p>
                </div>
            </div>
            ...
            <div class="half-unit">
                ...
                <div class="cont">
                    ...
                    <p><img src="{{ asset('images/up-small.png')}}" alt=""> 23.88%</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
                ...
                <div class="accordion" id="accordion2">
                    ...
                    <div class="accordion-group">
                        @include('components.accordion_group')
                    </div>
                </div><!--/accordion -->
            </div>
        </div>
